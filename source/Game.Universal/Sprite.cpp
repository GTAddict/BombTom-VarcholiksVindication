...
const std::map<SpriteType, std::string> Sprite::mTextureMap =
{
	...
	{ SpriteType::PaulOne,			"Content\\Textures\\PaulOne.png"	},
	{ SpriteType::PaulTwo,			"Content\\Textures\\PaulTwo.png"	},
	{ SpriteType::PaulThree,		"Content\\Textures\\PaulThree.png"	},
	{ SpriteType::PaulFour,			"Content\\Textures\\PaulFour.png"	},
	{ SpriteType::Paul5,			"Content\\Textures\\Paul5.png"		},
